      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-8">
        {members.map((member) => (
          <div key={member.id} className="group relative">
            {/* Overlay-link: hace clicable toda la tarjeta sin anidar <a> dentro de <a>
                (el LinkedIn de abajo queda por encima con z-10). */}
            <Link
            ...
            {(getLinkedin(member.name) || member.linkedin_url) && (
              <a
                ...
                className="relative z-10 mt-3 inline-flex items-center gap-1.5 text-sm text-muted-foreground hover:text-gold transition-colors"
              >
