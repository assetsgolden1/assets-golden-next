  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <button
        ref={ref}
        className={cn(
          'absolute left-2 top-1/2 -translate-y-1/2 z-10 flex h-10 w-10 items-center justify-center rounded-full bg-gold text-primary shadow-lg hover:bg-gold/90 disabled:opacity-40 transition-opacity',
          className
        )}
  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <button
        ref={ref}
        className={cn(
          'absolute right-2 top-1/2 -translate-y-1/2 z-10 flex h-10 w-10 items-center justify-center rounded-full bg-gold text-primary shadow-lg hover:bg-gold/90 disabled:opacity-40 transition-opacity',
          className
        )}
